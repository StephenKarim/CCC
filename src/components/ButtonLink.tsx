...
export default function ButtonLink({
  ...
  return (
    <PrismicNextLink
      className={clsx(
        `${russoOne.className}`,
        "hover:border-black-200/40 bg- relative inline-flex h-fit w-fit rounded-lg border border-[#333] bg-gray-200 bg-opacity-60 px-2 py-1 text-[#333333] outline-none ring-blue-800 transition-colors after:absolute after:inset-0 after:-z-10 after:animate-pulse after:rounded-full after:bg-blue-600 after:bg-opacity-0 after:blur-md after:transition-all after:duration-500 hover:text-sky-700 after:hover:bg-opacity-15 focus:ring-2",
        className,
      )}
      {...restProps}
    />
