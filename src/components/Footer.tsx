...
export default async function Footer() {
  ...
  return (
    <footer
      className={`${russoOne.className} border-background-contrast flex flex-col items-center justify-between gap-6 border-t bg-background bg-opacity-80 px-8 py-7 opacity-95 md:flex-row`}
    >
