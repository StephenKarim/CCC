...
export default async function Footer() {
  ...
  return (
    <footer
      className={`${russoOne.className} flex flex-col items-center justify-between gap-6 border-t bg-[#26619C] border-gray-200  bg-opacity-80 px-8 py-7 opacity-95 md:flex-row`}
    >
