...
const Testimonial = ({ slice }: TestimonialProps): JSX.Element => {
  return (
    <Bounded
      ...
      className={`${roboto.className} ios:bg-scroll bg-[url('/images/27.webp')] bg-cover bg-fixed bg-center px-4 py-14 text-secondary first:pt-10 md:px-6 md:py-20 lg:py-24`}
    >
      <h2
