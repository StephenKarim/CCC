...
export default function AnimatedContent({
  ...
  return (
    <div className="relative min-h-full min-w-full" ref={container}>
      ...
      <div
        className={`${russoOne.className} hero__heading bg-background absolute inset-0 mt-[25vh] flex h-fit w-[80vw] flex-col items-end rounded-r-lg bg-opacity-100 p-4 text-right font-bold opacity-0 shadow-lg sm:w-[60vw] md:justify-end`}
      >
        {isFilled.richText(slice.primary.heading) && (
        ...
        {isFilled.link(slice.primary.button_link) && (
          <ButtonLink
            className="hero__button bg-background rounded-lg border border-black text-[1rem] opacity-0 sm:text-lg md:text-[1.9vh] lg:text-xl"
