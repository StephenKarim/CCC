...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="relative h-[100vh] bg-[#070815] bg-[url('/images/church.jpg')] bg-cover bg-fixed bg-center bg-no-repeat px-4 py-14 will-change-scroll first:pt-10 md:px-6 md:py-20 lg:py-24"
    >
