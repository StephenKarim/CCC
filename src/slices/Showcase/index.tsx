...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="bg-fixed-ios relative bg-[url('/images/I3.jpg')] bg-cover bg-fixed bg-center px-4 py-14 text-secondary text-shadow-lg first:pt-10 md:px-6 md:py-20 lg:py-24"
    >
      {/* <AnimatedContent>
        </AnimatedContent> */}
      <PrismicRichText
