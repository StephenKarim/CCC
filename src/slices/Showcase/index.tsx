...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="relative bg-[#070815] bg-[url('/images/church.jpg')] bg-cover will-change-scroll bg-fixed bg-center px-4 py-14 first:pt-10 md:px-6 md:py-20 lg:py-24 h-[100vh]"
    >
